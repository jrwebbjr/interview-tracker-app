    ...
    return (
        <nav className="flex items-center justify-between flex-wrap bg-gradient-to-l from-indigo-600 via-blue-600 to-cyan-600 p-6 border-b-2 sticky top-0">
            <div class="flex items-center flex-shrink-0 text-white mr-6 ml-6">
                <span class="font-bold text-6xl tracking-tight hover:text-indigo-600 cursor-none">Ap-ply</span>
            </div>
            {/* 
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                <a onClick={handleJobLink} class="block mt-4 lg:inline-block lg:mt-0 text-cyan-100 hover:text-indigo-600 hover:text-4xl mr-6 text-xl cursor-pointer">
                    Jobs
                </a>
                <a onClick={handleNavLink} class="block mt-6 lg:inline-block lg:mt-0 text-cyan-100 hover:text-indigo-600 hover:text-4xl mr-6 text-xl cursor-pointer">
                    Create Job
                </a>
                </div>
                <div>
